...
var Resource = (function () {
    function Resource(dbName, resourceName, type, sirixInfo, authData, parent) {
        this.dbName = dbName;
    ...
    Resource.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, axios_1.default.put(this.sirixInfo.sirixUri + "/" + this.dbName + "/" + this.resourceName, data, {
                            headers: {
    ...
    Resource.prototype.read = function (nodeId, revision, maxLevel, withMetadata) {
        if (maxLevel === void 0) { maxLevel = null; }
        if (withMetadata === void 0) { withMetadata = false; }
        return __awaiter(this, void 0, void 0, function () {
            var created, params, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this.exists) return [3, 2];
                        return [4, this.create(null)];
                    case 1:
                        created = _a.sent();
                        if (!created) {
                            return [2, null];
                    ...
                    case 2:
                        ...
                        return [4, axios_1.default.get(this.sirixInfo.sirixUri + "/" + this.dbName + "/" + this.resourceName, {
                                params: params,
    ...
    Resource.prototype.delete = function (nodeId) {
        return __awaiter(this, void 0, void 0, function () {
            var params, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, axios_1.default.delete(this.sirixInfo.sirixUri + "/" + this.dbName + "/" + this.resourceName, { params: params, headers: { Authorization: this.authData.access_token } })];
                    case 1:
                        res = _a.sent();
                        if (res.status !== 204) {
                            console.error(res.status, res.data);
