...
var Sirix = (function () {
    function Sirix(username, password, sirixUri, callback) {
    ...
    Sirix.prototype.database = function (db_name, db_type) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, new database_1.default(db_name, db_type, this.sirixInfo, this.authData)];
            });
        });
    };
    Sirix.prototype.getInfo = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, axios_1.default.get(this.sirixInfo.sirixUri, {
                    ...
                    case 1:
                        ...
                        return [2, this.sirixInfo.databaseInfo];
                }
            });
        });
    };
    Sirix.prototype.delete = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, axios_1.default.delete(this.sirixInfo.sirixUri, { headers: { Authorization: this.authData.access_token } })];
                    case 1:
                        res = _a.sent();
                        if (res.status >= 400) {
                            console.error(res.status, res.data);
